...
def load_athlete_data():
    ...
    usa_athletes_df = pd.read_csv(usa_athletes_path)
    chinese_athletes_df = pd.read_csv(chinese_athletes_path)
...
# Define linguistic markers for individual vs. collective attribution
INDIVIDUAL_COLLECTIVE_MARKERS = {
    'english': {
        'individual_pronouns': ['he', 'she', 'his', 'her', 'him', 'himself', 'herself', 'i', 'my', 'me', 'mine'],
        'collective_pronouns': ['we', 'our', 'us', 'ourselves', 'team', 'american', 'americans', 'united states', 
        ...
        'collective_phrases': ['represent', 'representing', 'for the united states', 'for america', 'for the u.s.', 
    ...
    'chinese': {
        'individual_pronouns': ['他', '她', '他的', '她的', '其', '自己', '本人', '个人', '该选手', '这位选手',
                               '这名选手', '这位运动员', '这名运动员'],
        'collective_pronouns': ['我们', '我国', '中国', '国家', '祖国', '队', '中国队', '国家队', '中华', '我们的', 
                               '我国的', '中国的', '祖国的', '队的'],
        'individual_verbs': ['获得', '夺得', '赢得', '拿到', '摘得', '取得', '斩获', '创造', '打破', '刷新', 
                            '完成', '击败', '超越', '战胜'],
        'collective_phrases': ['为国争光', '为国家', '为祖国', '为中国', '中国骄傲', '国家荣誉', '中国自豪', 
